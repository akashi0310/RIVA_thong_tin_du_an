...
export default function TopBar({ onMenuClick }) {
  ...
  return (
    <>
      <header className="h-14 bg-white/80 backdrop-blur border-b border-indigo-100 flex items-center justify-between px-4 sticky top-0 z-10 no-print shadow-sm">
